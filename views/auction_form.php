...
<form action="" method="post" class="form-horizontal ajax-submit">
	<div class="form-group">
		...
		<div class="col-sm-7" id="fsUploadProgress">
			<?php if (!empty($info['pic'])):?>
    			...
    			<div class="up-item">
    			    ...
    			    <?php if (strpos($pic, '://') !== false):?>
                        <?= HTML::image($pic.'?imageView2/2/w/160/h/120', array('width'=>160, 'class'=>'img-thumbnail')) ?>
                    <?php else:?>
                        <?= HTML::image('/imagefly/w200-h150-c/' . $pic, array('width'=>160, 'class'=>'img-thumbnail')) ?>
                    <?php endif;?>
			...
			<?php endif;?>
			<div class="up-item">
			    <img id="pickfiles" class="img-thumbnail" src="<?= URL::site('media/img/default.png')?>">
			</div>
		</div>
	</div>
