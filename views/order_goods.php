...
<?php if ($info['deliver_status']==0):?>
<a href="<?php echo URL::site('order/deliver?order_id='.$info['id'])?>" qonclick="return confirm('确认现在发货吗？');" class="btn btn-info pull-right ajax-update">现在发货</a>
<?php endif;?>
</div>
